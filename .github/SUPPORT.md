# Getting help with kayadata

Thanks for using kayadata. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/kayadata/issues) to make sure the 
